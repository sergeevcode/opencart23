        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <?php if ($error_link) { ?>
                <div class="text-danger">Link error</div>
              <?php } ?>
            </div>
          </div>
          ...
          <div class="form-group ">
            <label class="col-sm-2 control-label" for="input-answer"><?php echo $entry_admin_answer; ?></label>
            <div class="col-sm-10">
              <textarea name="admin_answer" cols="60" rows="8" placeholder="<?php echo $entry_admin_answer; ?>" id="input-answer" class="form-control"><?php echo $admin_answer; ?></textarea>
              <?php if ($error_text) { ?>
                <span class="text-danger">
              <?php echo $error_text; ?></span>
              <?php } ?>
